...
- Use the *Intersection*  tool to combine intersect these buffers to get the areas which are only within 2km of the airport area, within a 1km radius from the stations, and within 500m from the road network. 
	- You have to run this intersect with each buffer to get the desired result, don't forget to make your outputs permanent
...
sic3RhcnQiOjExMTY1LCJlbmQiOjExMTc4LCJ0ZXh0IjoiLSBB
...
E4ODQ3ODA2MzQsNzI0NjE3OTAsLTIwNzMzOTMxMDMsMjAzMzg0
