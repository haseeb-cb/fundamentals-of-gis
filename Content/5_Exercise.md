...
6. Let's convert the Muurla_Soil.shp to a raster file
	...
	- Since rasters can’t have multiple attributes like shapefiles we need to select which field to use Column “PINTA” has the information which we want to use for the analysis, so this is the column you should select for “Field” -parameter. Name the file and choose the same cell size as you chose for the DEM.
...
M5NDEzMDUyfX0sImhpc3RvcnkiOls5MTk3ODQ5ODQsMjg0NTIz
