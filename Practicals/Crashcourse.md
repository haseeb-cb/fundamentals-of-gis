...
6. Now we’ll **write an expression that calculates the area of each small area of Helsinki in square kilometers**. On the right side of the Expression window is a list of drop-down menus.
	...
	2. Set the 
	4. Open the *Geometry* drop-down menu
	5. Double-click the *\$area* expression (you can also type *\$area* in the blank *Expression window*)
	6.  Just the *\$area* expression would calculate the area in square meters, but we want square kilometers. So we will divide it by 1 000 000. Click or type the division symbol (/), and type 1000000 after the division and click OK
	7. Click the *Save Edits* button and disable *Editing* mode
<!--stackedit_data:
...
p7InN0YXJ0IjoxMjY2OCwiZW5kIjoxMjY3NSwidGV4dCI6IkVk
aXRpbmcifSwiM1hVaWhUcmdOVFhubHJwMyI6eyJzdGFydCI6MT
I2MzYsImVuZCI6MTI2NDYsInRleHQiOiJTYXZlIEVkaXRzIn19
...
LCJoaXN0b3J5IjpbNjk1Nzg1NTA5LC0xNjQ3NTY3MzcyLC0xNj
YzNzQwNDEyXX0=
-->